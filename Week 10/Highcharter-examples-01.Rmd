...
d1 %>% 
  ...
  hc_tooltip(
    headerFormat = "<b>Fiscal Year: {point.x}</b> <a href='https://www.google.com' target='_blank'>SEC</a><br>",
    pointFormat = "<span style='color:#f82267'> \U25CF </span><b>Operating Profit: {point.y}</b>", # HTML entity &#9679;
    hideDelay = 3000,
    useHTML = TRUE) %>% 
  hc_add_theme(hc_theme_monokai())
